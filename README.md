...
5.  **Upload:** Connect the **IO0 pin** to ground while plugging in the USB to enter bootloader mode if you are building on a breadboard, otherwise just upload to the ESP32 using the MB board. Click Upload.
